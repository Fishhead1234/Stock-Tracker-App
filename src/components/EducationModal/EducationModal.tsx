...
import { GLOSSARY, LESSONS } from '../../services/educationData';
      ...
      >
        ...
        <div className="p-4 border-b border-navy-800 flex items-center justify-between bg-navy-950/70">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-[10px] uppercase tracking-wider text-gold-400 font-bold">Investor Education</span>
          ...
          {glossaryItem && (
            <>
              ...
              <div className="p-3 bg-navy-800/80 rounded-xl border border-navy-700">
                <span className="text-xs font-semibold text-slate-400 block mb-1">Definition</span>
              ...
              <div className="space-y-2">
                <span className="text-xs font-semibold text-slate-400 block">How to use this in your trading</span>
          ...
          {lessonItem && !glossaryItem && (
            <>
              ...
              <div className="p-3 bg-growth-950/30 border border-growth-600/30 rounded-xl text-xs text-growth-300">
                <span className="font-bold block mb-1">Key Beginner Rule:</span>
        ...
        <div className="p-3 border-t border-navy-800 bg-navy-950/70 flex items-center justify-between">
          <span className="text-[11px] text-slate-400">Master one concept at a time</span>
          <button
            onClick={onClose}
